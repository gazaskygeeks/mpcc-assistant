...
INSERT INTO mentors (first_name, last_name, email, date_of_arrival, current_stage, info) VALUES ('Smart', 'Smarter', 'Smart@smart', TO_DATE('17/12/2015', 'DD/MM/YYYY'), 'ALMOST', '{"mothers_name": "anything", "bio":"salam", "purpose_of_visit":"dalloul"}');
