...
const updateMentorField = (mentorObj, cb) => {
  ...
  const query = {
    text: 'update mentors set first_name=$1, last_name=$2, email=$3, date_of_arrival=TO_DATE($4, \'DD/MM/YYYY\'), date_of_birth=$5, current_stage=$6, info=$7 where id=$8 returning *',
